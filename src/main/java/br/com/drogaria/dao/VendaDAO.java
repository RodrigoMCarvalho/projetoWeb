	...
	public void salvar(Venda venda, List<ItemVenda> listItensVenda) {
		...
		try {
			...
			for (int posicao = 0; posicao < listItensVenda.size(); posicao++) {
				...
				itemVenda.setVenda(venda); //necessário realizar esse procedimento por causa que o código(PK) vem como null
										   //após o salvamento o hibernate seta o código correto
